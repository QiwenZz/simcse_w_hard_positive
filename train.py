...
class ModelArguments:
    ...
    use_hard_positive: bool = field(
        default=False,
        metadata={
            "help": "Whether to use hard positive during training."
        }
    )
    hard_positive_candidates: int = field(
        default=3,
        metadata={
            "help": "How many positive candidates to consider during hard positive training."
        }
    )
...
def main():
    ...
    def prepare_features(examples):
        ...
        if model_args.use_hard_positive:
